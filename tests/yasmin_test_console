...
class Test_Console(unittest.TestCase):
    ...
    def test_help(self):
        ...
        expected_output = (
            '["[User] (af471e7f-2d40-41ed-9cb4-4ea28f0b26f2) '
...
class Test_Console_show_with_dot_notation(unittest.TestCase):
    ...
    def test_show_dot_notations_invalid_syntax(self):
        ...
        b1.id = "1235"
        b1.save()
        output = Test_Console.get_stdout("BaseModel.show({})").format(b1.id).strip()
        expected_output = "*** Unknown syntax: {}.show(1235)".format("BaseModel")
        self.assertEqual(output, expected_output)
        ...
        p1.id = "1235"
        p1.save()
        output = Test_Console.get_stdout("Place.show({})").format(p1.id).strip()
        ...
        a1.id = "1235"
        a1.save()
        output = Test_Console.get_stdout("Amenity.show({})").format(a1.id).strip()
        ...
        s1.id = "1235"
        s1.save()
        output = Test_Console.get_stdout("State.show({})").format(s1.id).strip()
        ...
        r1.id = "1235"
        r1.save()
        output = Test_Console.get_stdout("Review.show({})").format(r1.id).strip()
...
class Test_Console_destroy_with_dot_notation(unittest.TestCase):
    ...
    def test_destroy_dot_notation_invalid_syntax(self):
        ...
        b1.id = "1235"
        b1.save()
        output = Test_Console.get_stdout("BaseModel.destroy({})").format(b1.id).strip()
        expected_output = "*** Unknown syntax: {}.destroy(1235)".format("BaseModel")
        self.assertEqual(output, expected_output)

        u1 = User()
        u1.id = "1235"
        u1.save()
        output = Test_Console.get_stdout("User.destroy({})").format(u1.id).strip()
        expected_output = "*** Unknown syntax: {}.destroy(1235)".format("User")
        self.assertEqual(output, expected_output)

        p1 = Place()
        p1.id = "1235"
        p1.save()
        output = Test_Console.get_stdout("Place.destroy({})").format(p1.id).strip()
        expected_output = "*** Unknown syntax: {}.destroy(1235)".format("Place")
        self.assertEqual(output, expected_output)

        a1 = Amenity()
        a1.id = "1235"
        a1.save()
        output = Test_Console.get_stdout("Amenity.destroy({})").format(a1.id).strip()
        expected_output = "*** Unknown syntax: {}.destroy(1235)".format("Amenity")
        self.assertEqual(output, expected_output)

        c1 = City()
        c1.id = "1235"
        c1.save()
        output = Test_Console.get_stdout("City.destroy({})").format(c1.id).strip()
        expected_output = "*** Unknown syntax: {}.destroy(1235)".format("City")
        self.assertEqual(output, expected_output)

        s1 = State()
        s1.id = "1235"
        s1.save()
        output = Test_Console.get_stdout("State.destroy({})").format(s1.id).strip()
        expected_output = "*** Unknown syntax: {}.destroy(1235)".format("State")
        self.assertEqual(output, expected_output)

        r1 = Review()
        r1.id = "1235"
        r1.save()
        output = Test_Console.get_stdout("Review.destroy({})").format(r1.id).strip()
        expected_output = "*** Unknown syntax: {}.destroy(1235)".format("Review")
        self.assertEqual(output, expected_output)
...
class Test_Console_update_with_dot_notation(unittest.TestCase):
    ...
    def test_update_dot_notation_attribute_name_missing(self):
        """Test update command of the console when attribute name is missing"""
    ...
    def test_update_dot_notation_attribute_value_missing(self):
        """Test update command of the console when attribute value is missing"""

        b1 = BaseModel()
        b1.id = "555"
        b1.save()
        output = Test_Console.get_stdout('BaseModel.update("555", "name")').strip()
        ...
        r1.id = "555"
        r1.save()
        output = Test_Console.get_stdout('Review.update("555", "name")').strip()
        self.assertEqual(output, expected_output)

        a1 = Amenity()
        a1.id = "555"
        a1.save()
        output = Test_Console.get_stdout('Amenity.update("555", "name")').strip()
        self.assertEqual(output, expected_output)
